...
def pin_and_record(ipfs,author,title,post,img,type):
 ...
 if result != 1:
  ...
  values = (str(ipfs),str(author),str(title),str(post),str(img),"c-squared")
...
if len(sys.argv) > 1 and sys.argv[1]:
  ...
  helpie_cake = s.get_account_history('c-squared', index_from=-1, limit = 10000)
  n = -1
  while n < 10000:
